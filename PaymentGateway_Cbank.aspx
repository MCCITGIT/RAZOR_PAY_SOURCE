<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentGateway_Cbank.aspx.cs" Inherits="RazorpaySampleApp.Default" %>
        ...
        <form runat="server">
            ...
            <div class="formListView" runat="server" id="idTable">
                <div class="formGroup">
                    ...
                    <asp:TextBox runat="server" ID="txtBookingId" CssClass="formContrl"></asp:TextBox>
                </div>
                <div class="formGroup">
